...
import IncidentReportAbi from './utils/abi.json';
const rows = [
...
function SignDemo() {
  ...
  async function onReportIncident(){
    ...
    try {
        let contract = await tronWeb.contract(IncidentReportAbi, 'TDY1d43nEU5xy4JBTUewpRAeNmbdmEeLen');
        let txId = await contract.storeIncident(incident).sendTrx();
  ...
  return (
    <div style={{ marginBottom: 200 }}>
      ...
      <TextField
        ...
        placeholder="Report Your incident"
      ></TextField>
      <Button style={{ marginRight: "20px" }} onClick={onReportIncident}>Report</Button>
    </div>
  );
}
